...
class _$StudyWeekImpl extends _StudyWeek {
  const _$StudyWeekImpl({required final List<bool> days})
      : _days = days,
        super._();
...
abstract class _StudyWeek extends StudyWeek {
  const factory _StudyWeek({required final List<bool> days}) = _$StudyWeekImpl;
