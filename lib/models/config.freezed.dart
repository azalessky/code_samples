...
mixin _$Config {
  ...
  GradingScale get gradingScale => throw _privateConstructorUsedError;
    ...
    return _then(_value.copyWith(
      ...
      studyWeek: null == studyWeek
          ...
          : studyWeek // ignore: cast_nullable_to_non_nullable
              as StudyWeek,
      gradingScale: null == gradingScale
          ? _value.gradingScale
          : gradingScale // ignore: cast_nullable_to_non_nullable
              as GradingScale,
...
class _$ConfigImpl implements _Config {
  ...
  @override
  String toString() {
    return 'Config(id: $id, themeMode: $themeMode, colorTheme: $colorTheme, backgroundImage: $backgroundImage, studyWeek: $studyWeek, gradingScale: $gradingScale, periodCount: $periodCount, repeatSchedule: $repeatSchedule)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.gradingScale, gradingScale) ||
  ...
  int get hashCode => Object.hash(runtimeType, id, themeMode, colorTheme,
      backgroundImage, studyWeek, gradingScale, periodCount, repeatSchedule);
...
abstract class _Config implements Config {
  const factory _Config(
      ...
      required final GradingScale gradingScale,
