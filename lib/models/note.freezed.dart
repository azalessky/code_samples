...
abstract class $NoteCopyWith<$Res> {
  ...
  @useResult
  $Res call({String id, DateTime date, String text});
}
...
class _$NoteImpl with DiagnosticableTreeMixin implements _Note {
  const _$NoteImpl({required this.id, required this.date, required this.text});
...
abstract class _Note implements Note {
  const factory _Note(
      ...
      required final String text}) = _$NoteImpl;
